 ...
 */
export const getCachedShirtList = async (filters) => {
    try {
 ...
 */
export const setCachedShirtList = async (filters, data) => {
    try {
        const redis = await getRedisClient();
        if (!redis) {
 ...
 */
export const invalidateShirtListCache = async () => {
    try {
        const redis = await getRedisClient();
        if (!redis) {
