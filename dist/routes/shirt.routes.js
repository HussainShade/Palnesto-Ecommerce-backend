...
import { createShirtHandler, batchCreateShirtsHandler, updateShirtHandler, getShirtHandler, listShirtsHandler, deleteShirtHandler, } from '../controllers/shirt.controller.js';
/**
 * Shirt routes
...
shirtRoutes.post('/batch', batchCreateShirtsHandler); // Batch create must come before /:id routes
